  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved attraction as @attraction" do
        ...
        post :create, {:attraction => { "region_id" => "invalid value" }}, valid_session
        assigns(:attraction).should be_a_new(Attraction)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested attraction" do
        ...
        Attraction.any_instance.should_receive(:update_attributes).with({ "region_id" => "" })
        put :update, {:id => attraction.to_param, :attraction => { "region_id" => "" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the attraction as @attraction" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Attraction.any_instance.stub(:save).and_return(false)
        put :update, {:id => attraction.to_param, :attraction => { "region_id" => "invalid value" }}, valid_session
        assigns(:attraction).should eq(attraction)
      end
